...
![2 87 raw audio audacity](/img/2_87_raw_audio_audacity.png){:height="200px" width="600px"}
...
![2 87 unfiltered PSDs](/img/2_87_unfiltered_PSDs.png){:height="200px" width="600px"}
...
![2 87 AP detection low pass filtered from PSDs](/img/2_87_AP_detection_low_pass_filtered_from_PSDs.png){:height="200px" width="600px"}

6. Attenuate the raw PSDs with the attenuation gains, resulting in a 40 Hz preprocessed PSD stream.
![2 87 48dbfiltered PSDs.png](/img/2_87_48dbfiltered_PSDs.png){:height="200px" width="600px"}
...
![2 87 AP detection low pass filtered from PSDs](/img/2_87_AP_detection_from_PSDs_sliding_6s_windows.png){:height="200px" width="600px"}
